...
def resnet18v1_5(pretrained=False, pretrained_cfg=None, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet18v1_5', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)
...
def resnet34v1_5(pretrained=False, pretrained_cfg=None, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet34v1_5', BasicBlock, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
...
def resnet50v1_5(pretrained=False, pretrained_cfg=None, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50v1_5', Bottleneck, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
...
def resnet101v1_5(pretrained=False, pretrained_cfg=None, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet101v1_5', Bottleneck, [3, 4, 23, 3], pretrained, progress,
                   **kwargs)
