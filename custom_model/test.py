...
'''
class res_routing(nn.Module):
    def __init__(self):
        super().__init__()
        self.rc1 = [] # init routing coefficient cache
...
class ResNet_moe(nn.Module):
    ...
    def __init__(self, denseblock, moeblock, layers, num_classes=1000, zero_init_residual=False,
        ...
        #self.moe_res = res_routing()
        #global res_routing1 
        #res_routing1 = self.moe_res 
        ...
        self.layer1 = self._make_layer(moeblock, 64, layers[0])
        self.layer2 = self._make_layer(moeblock, 128, layers[1], stride=2,
                                       dilate=replace_stride_with_dilation[0])
        self.layer3 = self._make_layer(moeblock, 256, layers[2], stride=2,
    ...
    def _forward_impl(self, x):
        ...
        '''
        x = self.layer1[0](x)
        self.layer1[1].moe_conv1.rwc = self.layer1[0].moe_conv2.rw
        x = self.layer1[1](x)
        self.layer2[0].moe_conv1.rwc = self.layer1[1].moe_conv2.rw

        x = self.layer2[0](x)
        self.layer2[1].moe_conv1.rwc = self.layer2[0].moe_conv2.rw
        x = self.layer2[1](x)
        self.layer3[0].moe_conv1.rwc = self.layer2[1].moe_conv2.rw

        x = self.layer3[0](x)
        self.layer3[1].moe_conv1.rwc = self.layer3[0].moe_conv2.rw
        x = self.layer3[1](x)
        self.layer4[0].moe_conv1.rwc = self.layer3[1].moe_conv2.rw

        x = self.layer4[0](x)
        self.layer4[1].moe_conv1.rwc = self.layer4[0].moe_conv2.rw
        x = self.layer4[1](x)
        '''
        x = self.layer1[0](x)
        #self.layer2[0].moe_conv1.rwc = self.layer1[0].moe_conv2.rw
        x = self.layer2[0](x)
        #self.layer3[0].moe_conv1.rwc = self.layer2[0].moe_conv2.rw
        x = self.layer3[0](x)
        #self.layer4[0].moe_conv1.rwc = self.layer3[0].moe_conv2.rw
        x = self.layer4[0](x)        
